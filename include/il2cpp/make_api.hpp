...
make_api(class_is_interface, bool, (const il2cpp::Il2CppClass* klass), klass);

// field
make_api(field_get_name, const char*, (il2cpp::FieldInfo* field), field)
make_api(field_get_value, void, (il2cpp::Il2CppObject* object, il2cpp::FieldInfo* field, void* value), object, field, value);
make_api(field_get_value_object, il2cpp::Il2CppObject*, (il2cpp::FieldInfo* field, void* value), field, value);
