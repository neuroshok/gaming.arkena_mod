...
namespace Unity
{
    struct Transform : ark::meta<Transform, Component>
    {
        ...
        Transform* get_parent() { return method_call(get_parent); }                                        // 0xB90450
        void set_parent(Transform* value) { return method_call(set_parent, value); }                       // 0xB91940
        Transform* get_parentInternal() { return method_call(get_parentInternal); }                        // 0xB90450
        void set_parentInternal(Transform* value) { return method_call(set_parentInternal, value); }       // 0xB90CC0
        Transform* GetParent() { return method_call(GetParent); }                                          // 0xB90450
        void SetParent(Transform* p) { return method_call(SetParent, p); }                                 // 0xB90CC0
        // void SetParent(Transform* parent, bool worldPositionStays) { return method_call(SetParent, parent, worldPositionStays); } // 0xB90C90
        ...
        bool IsChildOf(Transform* parent) { return method_call(IsChildOf, parent); }                             // 0xB90500
        // virtual // struct IEnumerator* GetEnumerator() { return method_call(GetEnumerator); } // 0xB90400 // Slot: 4
        Transform* GetChild(std::int32_t index) { return method_call(GetChild, index); }                                          // 0xB903D0
        ...
        {
            return method_call(TransformDirection_Injected, direction, ret);
        }                                                                                                                           // 0xB90CF0
        ...
        {
            return method_call(InverseTransformPoint_Injected, position, ret);
        }                                                                                               // 0xB90480
