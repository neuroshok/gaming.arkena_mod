...
namespace Unity
{
    ...
    struct Object : ark::meta<Object, il2cpp::Il2CppObject> // TypeDefIndex: 5440
    {
        ...
        cs::IntPtr* GetCachedPtr() { return method_call(GetCachedPtr); }                                   // 0x1D3AD0
        cs::string* get_name() { return method_call(get_name); }                                           // 0xB82B40
        void set_name(cs::string* value) { return method_call(set_name, value); }                            // 0xB82F20
        //static Object* Instantiate(Object* original, struct Vector3* position, struct Quaternion* rotation) { return method_call(Instantiate, original, position, rotation); } // 0xB82680
        static Object* Instantiate(Object* original) { return static_method_call(Object, Instantiate, original); } // 0xB820A0
        static Object* Instantiate_1(Object* original, Transform* parent, bool instantiateInWorldSpace) { return static_method_call(Object, Instantiate_1, original, parent, instantiateInWorldSpace); } // 0xB82240
        // void Destroy(Object* obj, float t) { return method_call(Destroy, obj, t); } // 0xB81AF0
        ...
        Object* FindObjectsOfType(cs::type* type) { return method_call(FindObjectsOfType, type); } // 0xB81F00
        ...
        */
        void CheckNullArgument(Object* arg, cs::string* message) { return method_call(CheckNullArgument, arg, message); } // 0xB818E0
        Object* FindObjectOfType(cs::type* type) { return method_call(FindObjectOfType, type); }                          // 0xB81E80
        cs::string* ToString() { return method_call(ToString); } // 0xB82A70 // Slot: 3
        ...
        //cs::string* ToString(Object* obj) { return method_call(ToString, obj); }                                             // 0xB82AE0
        cs::string* GetName(Object* obj) { return method_call(GetName, obj); }                                               // 0xB82050
        void SetName(Object* obj, cs::string* name) { return method_call(SetName, obj, name); }                              // 0xB82A40
...
namespace ark::method_info
{
	...
	method_rva(Unity::Object::Instantiate_1, 0xB82240)
