...
#include <autogen/Unity/Rect.hpp>
...
namespace Unity
{
    struct Sprite : ark::meta<Sprite, Object> // TypeDefIndex: 5474
    {
        ...
        /*
        static Sprite* CreateSprite(Texture2D* texture, Rect rect, Vector2 pivot, float pixelsPerUnit, std::uint32_t extrude,
        ...
        Vector2 get_pivot() { return method_call(get_pivot); }                                               // 0xB8C410
        ...
        /*Sprite* Create(Texture2D* texture, Rect rect, Vector2 pivot, float pixelsPerUnit, std::uint32_t extrude,
                              struct SpriteMeshType* meshType, struct Vector4* border, bool generateFallbackPhysicsShape)
        {
        ...
        static Sprite* Create(Texture2D* texture, Rect rect, Vector2 pivot) { return static_method_call(Sprite, Create, texture, rect, pivot); } // 0xB8BAB0
        ...
        Sprite* CreateSprite_Injected(Texture2D* texture, Rect rect, Vector2 pivot, float pixelsPerUnit,
        ...
        void get_pivot_Injected(Vector2 ret) { return method_call(get_pivot_Injected, ret); }   // 0xB8C3E0
    };
}
...
namespace ark::method_info
{
	...
	//method_rva(Unity::Sprite::CreateSprite, 0xB8B980)
    	method_rva(Unity::Sprite::Create, 0xB8BAB0)
