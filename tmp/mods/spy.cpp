...
namespace ark::mods
{
    ...
    void spy::on_enable()
    {
        ...
        ark::hook<&PlayerControl::RpcSetInfected>::overwrite(this, [this](auto original, auto&& self, cs::array<GameData_PlayerInfo>* player) -> void {
        ...
        [this](auto original, auto&& self, GameData_PlayerInfo* player_info, bool& in_range, bool& in_use_range) -> float
        {
